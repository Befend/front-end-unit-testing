...
describe("emailValidator", () => {
	...
	// 	{ email: "invalid.email@example.com", expected: true },
	// 	{ email: "another.invalid.email@example.com", expected: true },
	// 	{ email: "yet.another.invalid.email@example.com", expected: true },
	// ])("should return val when email is val", ({ email, expected }) => {
	// 	expect(emailValidator(email)).toBe(expected)
	// })
